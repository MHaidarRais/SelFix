...
class TypeTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request("http://localhost/selfrepair/index.php/api/gettipe").responseJSON{ (responseData) -> Void in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celltipe", for: indexPath) as! TypeTableViewCell
        ...
        var tipe_data = serverid["tipe_data"]
        let nama_data = serverid["nama_data"]
        
        //pindahkan ke label
        cell.labeltipe.text = nama_data
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let idStoryBoard = storyboard?.instantiateViewController(withIdentifier: "a") as! MaintanceTableViewController
        
        let id_kategori = arrKategori[indexPath.row]["tipe_data"]
