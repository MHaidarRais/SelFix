...
class MaintanceTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let params = ["tipe_data" : nampungid!]
        let url = "http://localhost/selfrepair/index.php/api/getdataBykelas"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellmaintance", for: indexPath) as! MaintanceTableViewCell
        
        var serverid = arrayberita[indexPath.row]
        
        var judul = serverid["judul"]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        selectedtipe = task["deskripsi"] as! String
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "passDetail" {
            if let indexPath = self.tableView.indexPathForSelectedRow {
                ...
                controller.passdesk = value["deskripsi"] as! String
